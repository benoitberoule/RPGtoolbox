...
public class CharacterSheetWarhammer extends CharacterSheet {
	...
	protected void createSheet() {
		...
		basic_ALabel.setLocation(sheet.getX()+ 120, sheet.getY()+435);
		...
		basic_BLabel.setLocation(sheet.getX()+ 151, sheet.getY()+435);
		...
		basic_BFLabel.setLocation(sheet.getX()+ 182, sheet.getY()+435);
		...
		basic_BELabel.setLocation(sheet.getX()+ 214, sheet.getY()+435);
		...
		basic_MLabel.setLocation(sheet.getX()+ 246, sheet.getY()+435);
		...
		basic_MagLabel.setLocation(sheet.getX()+ 278, sheet.getY()+435);
		...
		basic_PFLabel.setLocation(sheet.getX()+ 310, sheet.getY()+435);
		...
		basic_PDLabel.setLocation(sheet.getX()+ 342, sheet.getY()+435);
